...
public class crear_Myrest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        crearrest=findViewById(R.id.Myrest_Bcrear);nombre=findViewById(R.id.Myrest_name);
        nit=findViewById(R.id.Myrest_nit);propietario=findViewById(R.id.Myrest_propietario);
        calle=findViewById(R.id.Myrestcalle);telefono=findViewById(R.id.Myrest_telefono);
