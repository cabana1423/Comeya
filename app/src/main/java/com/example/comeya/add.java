            ...
            public void onSuccess(int statusCode, Header[] headers, JSONArray response) {
                ...
                for (int i=0;i<response.length();i++){
                    try {
                        ...
                        adaptadormyrest.add(new restView(obj.getString("nombre_rest"),"direccion: "+obj.getString("calle")
                                ,"Telefono: "+obj.getString("telefono"),obj.getString("foto_lugar"),obj.getString("lat"),obj.getString("lon"),obj.getString("_id")));
